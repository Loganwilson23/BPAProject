...
//  questions
   else if (input == "How do i buy a car?" || input == "how do i buy a car?") {
        return "You would go to the home page or go to our sales page";
    } else if (input == "where can i buy a car at" || input== "Where can i buy a car at") {
        return "You would go to the home page or go to our sales page";
    }
    else if (input == "where can i find about us page") {
     ...
     else if (input == "how do i use the finace calculator " || input == "How do i use the finace calculator") {
